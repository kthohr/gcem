...
{
    return ( x == 2 ? 0.69314718055994528623 : x == 3 ? 1.0986122886681097821 : x == 4 ? 1.3862943611198905725 : 
             x == 5 ? 1.6094379124341002818  : x == 6 ? 1.7917594692280549573 : x == 7 ? 1.9459101490553132319 : 
             x == 8 ? 2.0794415416798357477  : x == 9 ? 2.1972245773362195642 : 0.0 );
}
